...
- [@f1stnpm2/facilis-soluta-eum](#@f1stnpm2/facilis-soluta-eum)
...
```js
import copy from '@f1stnpm2/facilis-soluta-eum';
...
```js
import { copyStrict } from '@f1stnpm2/facilis-soluta-eum';
...
```js
import { createCopier } from '@f1stnpm2/facilis-soluta-eum';
...
|                    | Operations / second |
| ------------------ | ------------------- |
| **@f1stnpm2/facilis-soluta-eum**      | **5,880,312**       |
| lodash.cloneDeep   | 2,706,261           |
| clone              | 2,207,231           |
| deepclone          | 1,274,810           |
| fast-clone         | 1,239,952           |
| ramda              | 1,146,152           |
| @f1stnpm2/facilis-soluta-eum (strict) | 852,382             |
...
|                    | Operations / second |
| ------------------ | ------------------- |
| **@f1stnpm2/facilis-soluta-eum**      | **162,858**         |
| ramda              | 142,104             |
| deepclone          | 133,607             |
| fast-clone         | 101,143             |
| clone              | 70,872              |
| @f1stnpm2/facilis-soluta-eum (strict) | 62,961              |
...
|                    | Operations / second |
| ------------------ | ------------------- |
| **@f1stnpm2/facilis-soluta-eum**      | **303**             |
| fast-clone         | 245                 |
| deepclone          | 151                 |
| lodash.cloneDeep   | 150                 |
| clone              | 93                  |
| @f1stnpm2/facilis-soluta-eum (strict) | 90                  |
| ramda              | 42                  |
...
|                    | Operations / second |
| ------------------ | ------------------- |
| **@f1stnpm2/facilis-soluta-eum**      | **2,420,466**       |
| deepclone          | 1,386,896           |
| ramda              | 1,024,108           |
| lodash.cloneDeep   | 989,796             |
| clone              | 987,721             |
| @f1stnpm2/facilis-soluta-eum (strict) | 617,602             |
...
|                    | Operations / second |
| ------------------ | ------------------- |
| **@f1stnpm2/facilis-soluta-eum**      | **152,792**         |
| clone              | 74,347              |
| fast-clone         | 66,576              |
| lodash.cloneDeep   | 64,760              |
| ramda              | 53,542              |
| deepclone          | 28,823              |
| @f1stnpm2/facilis-soluta-eum (strict) | 21,362              |
